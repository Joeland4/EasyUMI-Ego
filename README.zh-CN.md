...
<p align="center" style="max-width:560px;margin:12px auto 0;">
  <img src="./Visualization/ego_opensource_trajectory_viz.png" alt="开源 Ego 数据集轨迹可视化" style="width:100%;max-width:560px;display:block;border-radius:8px;border:1px solid #e0e0e0;box-sizing:border-box;"/>
</p>
</div>
